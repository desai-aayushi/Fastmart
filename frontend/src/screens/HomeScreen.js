                        ...
                        <div className="slide">
                            ...
                            <div className="content">
                                <div className="title">
                                    ...
                                    <h5>Discover the best books and stationeries online with us</h5>
        ...
        <div>{error}</div>
            ...
            <section className="about-sec">
                ...
                <h2>About fastmart,</h2>
                    <p>Fastmart : On demand delivery of books and stationery where you can search for shops you want to purchase the product from or you can search for products in your city and get it delivered in minutes. </p>
                    <p>Fastmart is the idea dedicated to public good!</p>
                    <p>Enjoy Shopping!!</p>
